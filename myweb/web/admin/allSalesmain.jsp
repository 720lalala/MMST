    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          border-bottom-left-radius:5px;" id="salesUserid" placeholder="四个数字">
                                    <input type="submit" class="btn btn-outline-success btn-sm" onclick="return checkSalesUserid();" value="确定">
          ...
          border-bottom-left-radius:5px;" name="staffidI" id="staffidI">
                                ...
                                <table class="table table-bordered" border="5">
                                    ...
                                    %>
                                    <tr class="table-info">
                                    <td>总价格</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><input type="hidden" value="<%=sumprice%>" id="sumprice"/><fmt:formatNumber value="<%=sumprice%>" type="number" maxFractionDigits="2"/></td>
