                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 90px;">
                                            <div class="form-check" >
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="0" onclick="window.location.href='achievementStaffServlet?value=0'" >
                                                    今日
                                                </label>
                                            </div>
                                        </td>
                                        <td style="width: 90px;">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios2" value="1" onclick="window.location.href='achievementStaffServlet?value=1'">
                                                    今月
                                                </label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios3" value="2"  onclick="window.location.href='achievementStaffServlet?value=2'">
                                                    今年
                                                </label>
                                            </div>
                                        </td>
                                ...
                                <table class="table table-bordered" border="5">
                                    <tr class="table-info"><td>员工id</td><td>业绩</td></tr>
                                    <%
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 90px;">
                                            <div class="form-check" >
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1" id="optionsRadios11" value="0" onclick="window.location.href='achievementPaywayServlet?value=0'" >
                                                    今日
                                                </label>
                                            </div>
                                        </td>
                                        <td style="width: 90px;">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1" id="optionsRadios12" value="1" onclick="window.location.href='achievementPaywayServlet?value=1'">
                                                    今月
                                                </label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1" id="optionsRadios13" value="2"  onclick="window.location.href='achievementPaywayServlet?value=2'">
                                                    今年
                                                </label>
                                            </div>
                                        </td>
