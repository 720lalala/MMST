            ...
            throws IOException, ServletException
    {
        ...
        if(bool){
            ...
            if(bool)
            {
               ...
               // System.out.println("??");
                response.getWriter().print( "<script>alert(\"请确认输入的数据是否存在过!\");window.location.href='/error/errorInput.html'</script>");
            ...
            System.out.println("??");
            response.getWriter().print( "<script>alert(\"请确认输入的店铺id是否存在!\");window.location.href='/error/errorInput.html'</script>");
