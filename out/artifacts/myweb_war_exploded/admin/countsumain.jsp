                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 90px;">
                                            <div class="form-check" >
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="0" onclick="window.location.href='achievementUserServlet?value=0'" >
                                                    今日
                                                </label>
                                            </div>
                                        </td>
                                        <td style="width: 90px;">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios2" value="1" onclick="window.location.href='achievementUserServlet?value=1'">
                                                    今月
                                                </label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios3" value="2"  onclick="window.location.href='achievementUserServlet?value=2'">
                                                    今年
                                                </label>
                                            </div>
                                        </td>
                                ...
                                <table class="table table-bordered" border="5">
                                    <tr class="table-info"><td>区域</td><td>业绩</td></tr>
                                    <%
                                    ...
                                    <tr class="table-danger">
                                        <td><%=u.getUserid()%></td>
                                        <td><fmt:formatNumber value="<%=u.getAchievement()%>" type="number" maxFractionDigits="2"/></td>
                                    </tr>
                                    <%
                                            }}
                                    %>
                    ...
                    <div class="col-lg-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 90px;">
                                            <div class="form-check" >
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1" id="optionsRadios11" value="0" onclick="window.location.href='achievementUserPaywayServlet?value=0'" >
                                                    今日
                                                </label>
                                            </div>
                                        </td>
                                        <td style="width: 90px;">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1" id="optionsRadios12" value="1" onclick="window.location.href='achievementUserPaywayServlet?value=1'">
                                                    今月
                                                </label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optionsRadios1" id="optionsRadios13" value="2"  onclick="window.location.href='achievementUserPaywayServlet?value=2'">
                                                    今年
                                                </label>
                                            </div>
                                        </td>
                                ...
                                <table class="table table-bordered" border="5">
                                    <tr class="table-info"><td>支付方式</td><td>金额</td></tr>
                                    <%
                                    ...
                                    <tr class="table-danger">
                                        <td>现金</td>
                                        <td><fmt:formatNumber value="<%=a[0]%>" type="number" maxFractionDigits="2"/></td>
                                    </tr>
                                    <tr class="table-danger">
                                        <td>微信</td>
                                        <td><fmt:formatNumber value="<%=a[1]%>" type="number" maxFractionDigits="2"/></td>
                                    </tr>
                                    <tr class="table-danger">
                                        <td>支付宝</td>
                                        <td><fmt:formatNumber value="<%=a[2]%>" type="number" maxFractionDigits="2"/></td>
                                    </tr>
                                    <tr class="table-danger">
                                        <td>银行卡</td>
                                        <td><fmt:formatNumber value="<%=a[3]%>" type="number" maxFractionDigits="2"/></td>
                                    </tr>
                                    <tr class="table-info">
                                        <td>总金额</td>
                                        <td><fmt:formatNumber value="<%=a[0]+a[1]+a[2]+a[3]%>" type="number" maxFractionDigits="2"/></td>
                                    </tr>
