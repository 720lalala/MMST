		...
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="registerServlet" name="form" method="post" id="form">
				<div class="form-inner">
			        ...
			        <div class="form-group">
			          <div class="col-md-12">		          	
			            <label for="email" class="control-label">用户id</label>
			        ...
			        <div class="form-group col-md-12"  style="text-align: left">
			          ...
			          <div class="col-md-12" >
			          	<label class="radio-inline" style="text-align: center">
		          			<input type="radio" name="optionsRadios" id="optionsRadios1" value="pu"> 普通用户
		          		</label>
		          		<label class="radio-inline">
		          			<input type="radio" name="optionsRadios" id="optionsRadios2" value="su"> 管理员用户
		          		</label>
			          </div>             
			        </div>
			        <div class="form-group">
